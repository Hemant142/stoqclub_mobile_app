...
import {  getUserInfo } from "../Redux/authReducer/action";
...
export default function Home() {
  ...
  const Calling_App = params.get("Calling_App");
  const partnerId = params.get("partnerId");
  const Product = params.get("Product");
  let clientUserId = Cookies.get('userId')

  console.log(clientUserId,"clientUserId")
  // let userId=Cookies.get("userId_client")
  // console.log(userId, SessionId,Product,Calling_App,partnerId, linkId,"DEtails");
...
//  Cookies.set("user2Id_client", userId);
  ...
  useEffect(() => {
    dispatch(getAllBaskets(basicAuth))
...
>
  ...
  <Box  width="40%" display="flex" justifyContent="center" alignItems="center">
    <Image src={Logo} alt="Logo" />
        ...
        <CentrumSpecials allBasketsApiLoading={allBasketsApiLoading} allBaskets={allBaskets}  />
       <PopularBaskets allBasketsApiLoading={allBasketsApiLoading} allBaskets={allBaskets} />
      </Box>
